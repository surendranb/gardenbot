...
- Biological requirement: None viable without system restoration (no living specimens remain after >1 month downtime).
...
- All sensor streams (temp, hum, light, p1/p2/p3, press, gas) show consistent 0.0 readings since 2026-05-02 (per previous reports).
- Local telemetry archive shows last readings from 2026-03-22, confirming >1 month of zero data.
...
- Is there visible growth compared to the 7d baseline?
  No. The system has been non-functional for >1 month (last telemetry: 2026-03-22). Any biological specimens would have decomposed or desiccated beyond detection.
...
- Biological specimens: Non-viable/decomposed (inferred from >1 month system downtime).
